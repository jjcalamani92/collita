...
import { getQuery, typePageEcommerceCategory, typePageFoodCategory } from '../../src/utils'
import { useDeleteSitesFood, useDeleteProducts, useDeleteFoods, useDeletePages0Food, useDeletePages1Food, useDeleteSitesWear } from '../../src/hooks'
